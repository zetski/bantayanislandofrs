						...
						if (response.status === "success") {
							Swal.fire({
								...
								<tr>
									...
									<td><img src="${response.image}" alt="Officer Image" class="img-thumbnail" style="width: 50px; height: 50px;"></td>
									<td>
							...
							`;
							$('#officers-table tbody').append(newRow);
...
function previewOfficerImages(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            $('#officer-images-preview').html('<img src="' + e.target.result + '" class="img-thumbnail" style="width: 100px; height: 100px;">');
        };
