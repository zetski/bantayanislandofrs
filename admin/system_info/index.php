...
<div class="col-lg-12">
        ...
        <div class="card-body">
            <form action="" id="system-frm">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content[welcome]" cols="30" rows="2" class="form-control summernote"><?php echo is_file(base_app.'welcome.html') ? file_get_contents(base_app.'welcome.html') : "" ?></textarea>
                </div>
                <!-- System Logo -->
                <div class="form-group">
    ...
    <!-- Officer Form -->
    <div class="card card-outline rounded-0 card-success mt-3">
        <div class="card-header">
            <h5 class="card-title">Add Officer</h5>
        </div>
        <div class="card-body">
            <form id="officer-frm" enctype="multipart/form-data">
                <div class="form-group">
...
<script>
    ...
    $('#officer-frm').submit(function(e) {
        ...
        formData.append('f', 'save_officer');
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status === 'success') {
                    alert_toast("Officer saved successfully!", 'success');
                    location.reload();
                } else {
