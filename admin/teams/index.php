...
<style>
	...
	/* Responsive table overflow for smaller devices */
	...
	@media (max-width: 576px) {
		th:nth-child(3), td:nth-child(3), /* Code Column */
		th:nth-child(4), td:nth-child(4)  /* District Column */ {
			display: none;
		}
		.dropdown-menu {
			width: 100% !important;
...
<div class="card card-outline rounded-0 card-danger">
	<div class="card-header text-center text-md-left">
		...
		<div class="card-tools">
			<a href="./?page=teams/manage_team" id="create_new" class="btn btn-flat btn-primary btn-sm"><span class="fas fa-plus"></span> Create New</a>
		</div>
	</div>
	<div class="card-body">
