...
// Limit login attempts and lockout time
$max_attempts = 3;
    ...
    <div class="login-box">
        <div class="card card-danger my-2">
            <div class="card-body">
                ...
                <p class="mb-1 mt-3"><a href="forgot/forgot-password.php">Forgot password?</a></p>
                <p><a href="<?php echo base_url ?>">Go to Website</a></p>
            </div>
        </div>
    </div>
